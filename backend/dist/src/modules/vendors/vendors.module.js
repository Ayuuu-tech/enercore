...
const vendors_service_1 = require("./application/vendors.service");
const vendors_controller_1 = require("./presentation/vendors.controller");
const prisma_vendor_repository_1 = require("./infrastructure/prisma-vendor.repository");
...
exports.VendorsModule = VendorsModule = __decorate([
    (0, common_1.Module)({
        ...
        exports: [vendors_service_1.VendorsService, 'IVendorRepository'],
    })
], VendorsModule);
